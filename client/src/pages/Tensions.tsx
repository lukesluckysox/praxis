      ...
      {expanded && (
        <div className="px-5 pb-5 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              href={`https://axiomtool-production.up.railway.app/#/submit?claim=${encodeURIComponent(`${tension.poleA} vs ${tension.poleB}: ${tension.description}`)}`}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={`https://liminal-app.up.railway.app/tool/genealogist?claim=${encodeURIComponent(`${tension.poleA} vs ${tension.poleB}: ${tension.description}`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-[11px] font-mono tracking-wider border border-border/50 rounded-sm px-2.5 py-1 text-muted-foreground/60 hover:text-primary hover:border-primary/40 transition-colors"
            >
